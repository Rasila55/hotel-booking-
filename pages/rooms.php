...
// BUILD SQL using $conn from db.php
$where = "WHERE r.status = 'available'";

if ($adults > 0) {
    $where .= " AND r.max_adults >= " . (int)$adults;
}
if ($children > 0) {
    $where .= " AND r.max_children >= " . (int)$children;
}
...
// HEADER comes AFTER data is fetched
...
<style>
    ...
    .page-title-section h1 {
        ...
        letter-spacing:2px; font-family:Georgia,serif; display:inline-block;
    }
    ...
    .filter-sidebar {
        ...
        border-radius:6px; padding:20px; background:#fff; position:sticky; top:20px;
    }
    ...
    .filter-section input[type="number"] { width:100%; padding:7px 10px; border:1px solid #ccc; border-radius:4px; font-size:13px; margin-bottom:10px; }
...
<div class="rooms-layout">
                ...
                <?php foreach ($allFacilities as $facility): ?>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox"
                               name="facilities[]" value="<?php echo $facility; ?>"
    ...
    <div class="rooms-list">
            ...
            ?>
                <div class="room-card">
                    ...
                    <?php if (!empty($room['image'])): ?>
                        <!-- <img src="/staymate/images/rooms<?php echo htmlspecialchars($room['image']); ?>"
     ...
     class="room-card-img">
                    <?php else: ?>
                        <div class="room-card-img-placeholder">🛏️</div>
                    <?php endif; ?>
                    ...
                    <div class="room-card-actions">
                        <div class="room-price">
                            Rs. <?php echo number_format($room['price']); ?> per night
                        </div>

                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                            <a href="/staymate/pages/booking.php?room_id=<?php echo $room['id']; ?><?php echo $checkin ? '&checkin='.$checkin : ''; ?><?php echo $checkout ? '&checkout='.$checkout : ''; ?>&adults=<?php echo $adults ?: 1; ?>&children=<?php echo $children; ?>"
